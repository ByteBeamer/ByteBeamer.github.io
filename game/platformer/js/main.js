...
// boss Spider (enemy)
//
function BossSpider(game, x, y) {
    Phaser.Sprite.call(this, game, x, y, 'boss_spiders');
    ...
    this.game.physics.enable(this);
    this.body.collideWorldBounds = true;
    this.body.velocity.x = BossSpider.SPEED;
}

BossSpider.SPEED = 200;

// inherit from Phaser.Sprite
BossSpider.prototype = Object.create(Phaser.Sprite.prototype);
BossSpider.prototype.constructor = BossSpider;

BossSpider.prototype.update = function () {
    // check against walls and reverse direction if necessary
    if (this.body.touching.right || this.body.blocked.right) {
        this.body.velocity.x = -BossSpider.SPEED; // turn left
    }
    else if (this.body.touching.left || this.body.blocked.left) {
        this.body.velocity.x = BossSpider.SPEED; // turn right
    }
};

BossSpider.prototype.die = function () {
